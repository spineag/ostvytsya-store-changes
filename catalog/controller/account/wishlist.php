	...
	public function getList(): string {
		...
		foreach ($results as $result) {
			...
			if ($product_info) {
				...
				$image = $this->model_tool_image->resize(html_entity_decode($product_info['image'], ENT_QUOTES, 'UTF-8'), 400,300 /*$this->config->get('config_image_wishlist_width'), $this->config->get('config_image_wishlist_height')*/);
				} else {
					$image = false;
				}
